        ...
        <div class="container">
            <div class="row flex-row-reverse">
                ...
                <div class="col-lg-9 col-md-12 col-12">
                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="{{ url ('/detail/' . $item->id.'/show')}}">
                                            ...
                                            <img style="width:250px ;height:250px; border: 2px solid red; padding: 10px; border-radius: 25px;" class="primary-img" src="{{url ('cover').'/'.$item->cover}}" alt="product-img">
                                        </a>
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <div class="product-card-price">
                                            <span class="card-price-regular">{{$item->kode_ayam}}</span>
                                            <span class="card-price-compare text-decoration-line">{{ $item->kategori->jenis_ayam }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- PAGINATION -->
                    {{ $Pagination->links('vendor.pagination.pagination_view') }}
                    <!-- END PAGINATION -->
                </div>
                <!-- product area end -->
