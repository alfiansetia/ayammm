                    ...
                    <div class="col-lg-9 col-md-12 col-12">
                        <div class="filter-sort-wrapper d-flex justify-content-between flex-wrap">
                            <div class="collection-title-wrap d-flex align-items-end">
                                ...
                                <p class="collection-counter text_16 mb-0 ms-2">({{ count($ayam) }} Ayam Tersedia)</p>
                            </div>
                                        ...
                                        <div class="product-card">
                                            ...
                                            <div class="product-card-details">
                                                ...
                                                <div class="product-card-price">
                                                    ...
                                                    <span
                                                        class="card-price-compare text-decoration-line">{{ $item->kategori->jenis_ayam }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="filter-lists list-unstyled mb-0">
                                            <li class="filter-item">
                                                <label class="filter-label">
                                                    ...
                                                    <span class="filter-text"> <a style="color:#000"
                                                            href="{{ url("tampil/$item->id") }}">{{ $item->jenis_ayam }}</a></span>
                                                </label>
                                            </li>
