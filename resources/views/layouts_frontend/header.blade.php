...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('frontend_template/landingPage')}}/assets/img/ayam_logo.png" type="image/x-icon">
    <!-- fonts -->
                    ...
                    <div class="col-lg-3 d-lg-block d-none">
                        <div class="announcement-meta-wrapper d-flex align-items-center justify-content-end">
                            ...
                            <div class="announcement-meta d-flex align-items-center">
                                ...
                                <a class="announcement-login announcement-text text-white " onclick="event.preventDefault();
        ...
        <header class="sticky-header border-btm-black header-1">
            <div class="header-bottom">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-4">
                            <div class="header-logo">
                                <a href="" class="logo-main">
                                    <img style="height: 60%;width:40%" src="{{asset('frontend_template/landingPage')}}/assets/img/ayam_logo.png" loading="lazy" alt="bisum">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-8 col-8">
                            <div class="header-action d-flex align-items-center justify-content-end">
                                ...
                                <a class="header-action-item header-cart ms-4" href="{{ url (' $cart->id.#drawer-cart' )}}" data-bs-toggle="offcanvas">
                                    ...
                                    @if($getCartNumber !="") <span class="" style="z-index: index 1; border-radius: 50%; background-color:red; color:#fff ; margin-left: 10 px;">{{$getCartNumber}}</span>@endif
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <!-- <a class="header-action-item header-cart ms-4" href="{{ url (' $cart->id.#drawer-cart' )}}" data-bs-toggle="offcanvas">
                    ...
                    <span class="" style="border-radius: 50%; background-color:red; color:#fff ; margin-right: -1 px;"></span>
                    @if($getCartNumber !="") <span class="" style="border-radius: 50%; background-color:red; color:#fff ; margin-right: -1 px;">{{$getCartNumber}}</span>@endif
                </a> -->
            </div>
        </header>
        <!-- header end -->