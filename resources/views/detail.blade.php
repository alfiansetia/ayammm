            ...
            <div class="row">
                            ...
                            <div class="img-large-slider common-slider" data-slick='{
                                ...
                                <div class="img-large-wrapper">
                                    ...
                                    <a href="/images/{{ $img->image }}" data-fancybox="gallery">
                                        <img style="height: 300px;width:400px" src="/images/{{ $img->image }}" alt="img">
                                    </a>
                                </div>
                            ...
                            <div class="img-thumb-slider common-slider" data-vertical-slider="true" data-slick='{
                                ...
                                <div>
                                    <div class="img-thumb-wrapper">
                                        <img src="/images/{{ $img->image }}" alt="img">
                                    </div>
                                </div>
                                @endforeach
                                @endif
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="product-details ps-lg-4">
                        ...
                        <h2 class="product-title mb-3">{{$post->jenis_ayam_id}}</h2>

                        <div class="product-sku product-meta mb-1">
                            <strong class="label">Kode :</strong> {{$post->kode_ayam}}
                        </div>
                        <div class="product-sku product-meta mb-1">
                        ...
                        <div class="product-vendor product-meta mb-3">
                            <strong class="label">Jenis Ayam :</strong> {{$post->deskripsi}}
                        </div>


                        @foreach($kontak as $item)
                        <form class="product-form" action="https://wa.me/{{ $item->no_telp }}">
                            @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-12 col-12">
                            <div class="desc-content">
                                <h4 class="heading_18 mb-3">{{ $post->jenis_ayam_id }}</h4>
                                <p class="text_16 mb-4">{{ $post->ayam_import }}</p>
                            </div>
                        </div>
                        ...
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="{{ url ('/tampil')}}">
                                    <img style="width:255px ;height:255px; border: 2px solid red;" class="secondary-img" src=" {{url ('cover').'/'.$item->cover}}" alt="product-img">

                                    <img style="width:255px ;height:255px; border: 2px solid red;" class="primary-img" src=" {{url ('cover').'/'.$item->cover}}" alt="product-img">
                                </a>

                                <div class="product-card-action product-card-action-2">
                                    <a href="{{ url ('/detail/' . $item->id.'/show')}}" class="quickview-btn btn-primary">QUICKVIEW</a>
                                    @foreach($kontak as $item)
                                    <a href="https://wa.me/{{$item->no_telp}}" class="addtocart-btn btn-primary">Pesan</a>
                                    @endforeach
                                </div>
                            ...
                            <div class="product-card-details text-center">
                                <h3 class="product-card-title"><a href="collection-left-sidebar.html"> {{ $item->jenis_ayam_id }}</a>
                                </h3>
