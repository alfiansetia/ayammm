                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>@yield('title')</h6> <a href="/ayam/create"
                                    ...
                                    <tbody style="text-align: center;">
                                        ...
                                        @foreach ($data as $key => $ayam)
                                            <tr>
                                                ...
                                                <td><img src="{{ $ayam->cover }}" class="img-responsive"
                                                        style="max-height:100px; max-width:100px" alt=""
                                                        srcset=""></td>
                                                <td><a href="{{ url('/ayam/' . $ayam->id . '/edit') }}"
                                                        class="btn btn-outline-primary">Update</a></td>

                                                <td class="">
                                                    <a href="{{ url('/ayam/' . $ayam->id . '/show') }}"
                                                ...
                                                <td>
                                                    <form onsubmit=" return confirm('Yakin menghapus data')"
                                                        class="d-inline" action="{{ '/ayam/' . $ayam->id }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
