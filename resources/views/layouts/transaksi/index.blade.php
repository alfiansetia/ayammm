            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>@yield('title')</h6> <a href="/trans/create" class="badge badge-sm bg-gradient-primary">Tambah Data</a>
                    </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody style="text-align: center;">
                                    ...
                                    <tr>
                                        <th scope="row">{{ $trans->firstItem()+ $key }}</th>
                                        ...
                                        <td><a href="{{ url ('/trans/' . $item->id.'/edit')}}" class="btn btn-outline-primary">Update</a></td>

                                        <td class="">
                                            <a href="{{ url ('/trans/' . $item->id.'/show')}}" class="btn btn-outline-info" data-toggle="tooltip" data-original-title="Edit user">
                                        ...
                                        <td>
                                            <form onsubmit=" return confirm('Yakin menghapus data')" class="d-inline" action="{{'/trans/'.$item->id}}" method="post">
                                                @csrf
                                                @method('DELETE')
