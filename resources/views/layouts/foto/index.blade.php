            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>@yield('title')</h6> <a href="/gambar/create" class="badge badge-sm bg-gradient-primary">Tambah Data</a>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $post->jenis_ayam }}</td>
                                        <td>{{ $post->kode_ayam }}</td>
                                        <td>{{ $post->berat }}</td>
                                        <td>{{ $post->status }}</td>
                                        <td>{{ $post->usia }}</td>
                                        <td>{{ $post->jenis_ayam }}</td>
                                        ...
                                        <td class="">
                                            <a href="{{ url ('/gambar/' . $post->id.'/show')}}" class="btn btn-outline-info" data-toggle="tooltip" data-original-title="Edit user">
                                        ...
                                        <td>
                                            <form onsubmit=" return confirm('Yakin menghapus data')" class="d-inline" action="{{'/gambar/'.$post->id}}" method="post">
                                                @csrf
                                                @method('DELETE')
