...
CREATE TABLE `ayam` (
  ...
  `jenis_ayam_id` varchar(255) NOT NULL,
  `kode_ayam` varchar(255) NOT NULL,
...
CREATE TABLE `posts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `jenis_ayam_id` varchar(50) NOT NULL,
  `kode_ayam` varchar(255) DEFAULT NULL,
...
(5, 'satu@gmail.com', 'satu@gmail.com', NULL, '$2y$10$I9RX3qGpIclIcOYwKj.YN.FwUyZJGBH0zlTCVYbtSKt42FCUv9rYG', NULL, '2023-10-26 10:57:48', '2023-10-26 10:57:48', 1, NULL);
